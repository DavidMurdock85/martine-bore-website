...
type Ref = ((instance: HTMLElement | null) => void) | React.MutableRefObject<HTMLElement | null> | null;

function Base(props: BaseProps, ref: Ref): React.ReactElement {
  const Tag = props.tag || "div";
  // @ts-ignore
  return <Tag ref={ref} {...getProps(props)} />;
};

const forwardRef: React.ExoticComponent<BaseProps> = React.forwardRef(Base);
