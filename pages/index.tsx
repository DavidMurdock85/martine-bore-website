  ...
  return (
    ...
    >
      <Base className="home-image">
        <Image src={`/images/homepage-images/main-image.jpeg`} alt="A photo of the Martine Boré Antiques Gallery in Ambleside West Vancouver." width="2000px" height="1500px" />
      </Base>
    </PageWrapper>
  )
}
