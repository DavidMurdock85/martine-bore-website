export const jewelry = {
  ...
  "rings-cocktail-gold-diamonds": {
    ...
    description:
      "An 18kt gold coctail ring set with 5 diamond in a ribbon shape, Mid 20th Century",
  ...
  "rings-emerald-diamonds-oval-cabochon-art-deco": {
    ...
    description:
      "An Art Deco emerald, diamond and white gold cabochon ring c. 1930s",
    dimensions: "size 4",
    price: "inquire"
  ...
  "rings-emerald-square-victorian": {
    ...
    description:
      "A square emerld surrounded by diamonds set in a 14kt gold ring, 19th Century.",
  ...
  "rings-emerald-diamonds-heart-georgian-era": {
    ...
    description:
      "A Georgian Era teardrop emerald surrounded by 27 diamonds in a 14kt gold ring, Early 19th Century",
    dimensions: "6 1/2",
    price: "inquire"
  ...
  "rings-amethyst-diamond-brutalist": {
    ...
    description:
      "Emerald cut amethyst and diamonds set in a 18kt Brutalist sculptural ring c. 1970s",
  ...
  "rings-cocktail-sapphire-art-deco": {
    ...
    description:
      "An sapphire surounded by diamonds set in an 18kt white gold ring, Art Deco Period, Early 20th Century",
    dimensions: "size 7 3/4",
    price: "$1800"
  ...
  "rings-jade-oval": {
    ...
    description:
      "Oval cabochon burmese jade set in 14kt gold ring, Mid 20th Century",
    dimensions: "size 7 3/4",
    price: "$2500"
  ...
  "rings-emerald-diamond-brutalist": {
    ...
    description:
      "Brutalist Modern emerald, diamond and 14kt cocktail ring, Mid 20th Century",
    dimensions: "size 5",
    price: "$1800"
  ...
  "rings-amethyst-diamond-snake": {
    ...
    description:
      "21 carat Amethyst surrounded by 170 diamonds and set in an 18kt white gold ring, Late 20th Century.",
  ...
  "bracelets-pearls-ruby": {
    ...
    description:
      "Pearl Ruby and 14kt gold multi strand bracelet, Mid 20th Century",
  ...
  "bracelets-diamonds-gold-hinged-bangle": {
    ...
    description:
      "14kt gold hinged bangle with diamond chips, Mid 20th Century. Marked 14kt",
    dimensions: "7 x 1/4 inches",
    price: "$1500"
    //productId: "bracelets-diamonds-gold-hinged-bangle"
  },
  ...
  "bracelets-gold-amethyst-edwardian": {
    ...
    price: "$895"
    //productId: "bracelets-gold-amethyst-edwardian"
},
*/
  ...
  "bracelets-heart-chain-gold-victorian": {
    ...
    description:
      "9ct gold heart locket clasp and chain link bracelet, Victorian Era, 19th Century.",
    dimensions: "",
    price: "inquire"
  ...
  "bracelets-heart-gold-victorian": {
    ...
    description:
      "9ct gold heart locket clasp and chain link engraved bracelet, Victorian Era, 19th Century",
    dimensions: "7 x 1/2 inches",
    price: "$600"
    //productId: "bracelets-heart-gold-victorian"
  },
...
*/
  ...
  "necklaces-emerald-diamond-floral": {
    ...
    description:
      "Stunning necklace with 40 emeralds, 157 diamonds set in 18kt gold, Mid 20th Century",
    dimensions: "16.75 inches",
    price: "inquire"
  ...
  "necklaces-sapphire-emerald-peacock-faberge": {
    ...
    description:
      "An 18kt Sapphire, Emerald and Gold Peacock Necklace by Faberge, Mid 20th Century. Chain not included.",
    dimensions: "1 1/2 x 1 1/2 inches",
    price: "inquire"
    //productId: "necklaces-sapphire-emerald-peacock-faberge"
  },
  ...
  "brooches-lion-emerald-ruby-hammerman": {
    ...
    description:
      "A diamond, emerald and ruby lion brooch in 14kt gold by Hammerman Brothers, Germany mid 20th century",
    dimensions: "",
    price: "inquire"
  ...
  "brooches-citrine-rubys-pearls-edwardian": {
    ...
    description:
      "An Edwardian Era citrine and pearl brooch with rubies set in gold, early 20th century",
    dimensions: "",
    price: "inquire"
  ...
  "brooches-ribbon-pearls": {
    ...
    description:
      "Modernist gold ribbon brooch set with 19 pearls, Mid 20th Century",
    dimensions: "",
    price: "inquire"
  ...
  "brooches-tree-pearls": {
    ...
    dimensions: "",
    price: ""
    //productId: "brooches-tree-pearls"
  },
  ...
  "silver-jewelry-bangle-tiffany": {
    ...
    description:
      "A modernist sculpted sterling bangle, late 20th century. Marked Tiffany",
    dimensions: "",
    price: ""
  ...
  "silver-jewelry-necklace-amber-poland": {
    ...
    description:
      "A modernist sculptural sterling and amber cabochon necklace, Poland Mid 20th Century",
    dimensions: "",
    price: "inquire"
  ...
  "silver-jewelry-necklace-modernist-choker": {
    ...
    description:
      "A sculptural sterling choker necklace, late 20th century. Marked 925",
    dimensions: "",
    price: "inquire"
  ...
  "silver-bracelet-turquoise-southwest": {
    ...
    description:
      "A silver bangle set with polished turquoise cabochons and Navajo motifs, late 20th century",
    dimensions: "",
    price: "inquire"
  ...
  "silver-turquoise-coral-bangle-southwest": {
    ...
    description:
      "A silver bangle set with polished turquiose and coral, late 20th century  ",
    dimensions: "",
    price: "inquire"
  ...
  "silver-necklace-pendant-turquiose-orlando-crespin": {
    ...
    description:
      "A turquoise necklace with sterling and inlaid turquoise pendant, late 20th century. Signed O. Crespin",
    dimensions: "",
    price: "inquire"
  ...
  "silver-bracelet-northwest-native": {
    ...
    description:
      "A carved sterling silver bangle with Northwest native motifs, late 20th century. Signed ND",
    dimensions: "",
    price: "inquire"
  ...
  "silver-bracelet-mexican": {
    ...
    description:
      "A silver linked bracelet with mexican native motifs, Mexico mid 20th century",
    dimensions: "",
    price: "inquire"
  ...
  "silver-necklace-semi-precious-yellow": {
    ...
    description:
      "a silver and cut lemon quartz pendant necklace, late 20th century",
    dimensions: "",
    price: "inquire"
