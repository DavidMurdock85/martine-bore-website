export const artByPeriod = {
  ...
  "victorian-painting-english-alexander-ligitt": {
    ...
    description:
      "Victorian Era English Portrait Painting by Alexander Ligitt c. 1860s. Painted in oil on canvas.",
    dimensions: "",
    price: "inquire"
  ...
  "victorian-tea-caddy-wood": {
    ...
    description:
      "Victorian Era Wooden Tea Caddy with covered compartments and bowl c. 1860s",
    dimensions: "",
    price: "inquire"
  ...
  "victorian-box-miniature-portrait": {
    ...
    description:
      "Victorian Era tortoise shell and bone Jewelry Box with a miniature portrait of a lady.",
    dimensions: "",
    price: "inquire"
    // productId: "victorian-box-miniature-portrait"
  },
  ...
  "art-nouveau-vase-cameo-glass-émile-gallé-rio": {
    ...
    description:
      "Art Nouveau Émile Gallé Rio de Janeiro cameo glass vase c. 1910. A large and exceptionally rare example of Émile Gallé's work.",
    dimensions: "",
    price: "inquire"
  ...
  "art-nouveau-vase-glass-kralik-green-sterling": {
    ...
    description:
      "Art Nouveau Bohemian Green Glass Vase with a Sterling Silver Neck by Kralik c. 1900. The neck is marked.",
    dimensions: "",
    price: "$400"
  ...
  "art-nouveau-vase-glass-steuben-aurene-frederick-carder": {
    ...
    description:
      "Art Nouveau Steuben Blue Aurene Glass Vase by Frederick carder c. 1910.  Designed by Frederick Carder in 1904 ",
  ...
  "art-nouveau-plate-royal-vienna-portrait": {
    ...
    description:
      "Art Nouveau Royal Vienna Green Cabinet Plate signed C. Kiesel c. 1900. Hand painted in a neo classical style.",
    dimensions: "",
    price: "$1800"
    // productId: "art-nouveau-plate-royal-vienna-portrait"
  },
  ...
  "art-deco-vase-enamel-glass-legras": {
    ...
    description:
      "Art Deco French Enameled Glass Vase with a floral motif by Legras c. 1930s.",
  ...
  "art-deco-vase-porcelain-haviland-limoges": {
    ...
    description:
      "Art Deco French porcelain moonflask vase with a hand painted floral motif by Haviland Limoqes c. 1930s",
  ...
  "art-deco-vase-consolidated-lovebirds-green-glass": {
    ...
    description:
      "Art Deco painted glass lovebird vase by Consolidated Glass c. 1930s. Beautifully hand painted in green with a pink accents.",
  ...
  "art-deco-tea-set-edna-bess": {
    ...
    description:
      "Art Deco Tea Set with geometric patterns by Edna Best c. 1930s",
    dimensions: "",
    price: "$1200"
    // productId: "art-deco-tea-set-edna-bess"
  },
  ...
  "modern-centerpiece-glass-green-blenko": {
    ...
    description:
      "Modern Green Glass Centerpiece by Blenko c. 1950s. A rare piece of early production blenko. Signed on base",
  ...
  "modern-vase-glass-murano-sommerso-seguso-flavio-poli": {
    ...
    description:
      "Modern Purple Murano Glass Sommerso Vase by Flavio Poli for Seguso Vetri D'Arte c. 1960. A large example thats beautifully blown in several shades of purple.",
  ...
  "modern-bowl-porcelain-rosenthal-winblad": {
    ...
    description:
      "Modern Centerpiece Bowl by Bjorn Wiinblad for Rosenthal Studio Line c. 1970s. Beautifully detailed in Whimsical danish designs.",
  ...
  "modern-bowl-glass-willy-johansson-hadeland": {
    ...
    description:
      "Rare Norwegian Modern art glass centerpiece bowl by Willy Johansson for Hadeland c. 1960s",
  ...
  "modern-vase-glass-jan-bernek-czech": {
    ...
    description:
      "Modern Purple Sculptural Glass Vase by Jan Beranek for Skrdlovice c. 1960s.",
  ...
  "modern-paperweight-ceramic-fornasetti": {
    ...
    description:
      "Rare Modern Paperweight Cube by Piero Fornasetti c. 1950s.  Designed by Fornasetti in the early 1950s.",
    dimensions: "2 1/2 x 2 1/2 x 2 1/2 inches",
    price: "$500"
  ...
  "modern-vase-ceramic-tapio-wirkkala-rosenthal": {
    ...
    description:
      "Modern Pollo Vase by Tapio Wirkkala for Rosenthal Studio Line c. 1971. Comes with the original Rosenthal box.",
    dimensions: "5 x 4 x 3 1/2 inches",
    price: "$125"
    // productId: "modern-vase-ceramic-tapio-wirkkala-rosenthal"
  }
};
